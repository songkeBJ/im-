...
//import com.sellerNet.backManagement.entity.PcOrder;
...
//import com.sellerNet.backManagement.service.OrderService;
//import com.sellerNet.backManagement.service.PcOrderService;
...
////			  BigDecimal money1 = new BigDecimal(userOne2.getBalance());
...
//	         map.put("version", "1.0");
//	         map.put("notify_url",URLUtil.getHomeUrl(request.getScheme(), request.getServerName(), request.getServerPort())+AlipayConfig.service);
//             LOGGER.info("支付宝回调地址"+URLUtil.getHomeUrl(request.getScheme(), request.getServerName(), request.getServerPort())+AlipayConfig.service);
...
//	         map4.put("notify_url",  URLEncoder.encode(URLUtil.getHomeUrl(request.getScheme(), request.getServerName(), request.getServerPort())+AlipayConfig.service,"UTF-8"));
...
//
////	       Boolean boolean1 = AlipaySignature.rsaCheck(map, rsaSign, AlipayConfig.alipay_public_key, "UTF-8", "RSA");
//	         
...
//			int time = TimeStampUtils.getTimestamp();
//			pcOrder.setCreateTime(time);
//			pcOrder.setUserId(Integer.parseInt(id.toString()));
//			pcOrder.setMoney(amount);
//			pcOrder.setStatus(10);
//			pcOrderService.insert(pcOrder);
//	        return json; 
//	     }
//	
//	@ResponseBody
