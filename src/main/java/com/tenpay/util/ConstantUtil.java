...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxf03ce69e0c3c41ae";//微信开发平台应用id
	public static String APP_SECRET = "20295301e0b2189e252a0624e1e925f2";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1333545201";//财付通商户号
	public static String PARTNER_KEY = "123456789012345678901234567890AB";//商户号对应的密钥
