...
<table id="dg" title="个人通话权限列表" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/admin/getUserList.do" fit="true" toolbar="#tb">
    <thead>
    	<tr>
...
<div id="tb">
	...
	<div>
		&nbsp;手机号码：&nbsp;<input type="text" name="phoneNumber" id="phoneNumber" size="20" onkeydown="if(event.keyCode==13) searchUser()"/>
			&nbsp;用户id：&nbsp;<input type="text" name="userId" id="userId" size="20" onkeydown="if(event.keyCode==13) searchUser()"/>
